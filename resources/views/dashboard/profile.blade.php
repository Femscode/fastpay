                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center font-weight-bold my-2">
                                        ...
                                        <!--begin::Item-->
                                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                        <a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100">Account Information</a>
                                        <!--end::Item-->
                                    </div>
                                    <!--end::Breadcrumb-->
                                </div>
                                        ...
                                        <div class="card-body pt-4">
                                            ...
                                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="account-information.html" class="navi-link py-4 active">
                                                ...
                                                <div class="navi-item mb-2">
                                                    <a href="#" class="navi-link py-4" data-toggle="tooltip" title="Coming soon..." data-placement="right">
                                                        <span class="navi-icon mr-2">
                                                            <span class="svg-icon">
                                                                <!--begin::Svg Icon | path:/metronic/theme/html/demo2/dist/assets/media/svg/icons/Layout/Layout-top-panel-6.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24" />
                                        ...
                                        <!--begin::Form-->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <button type="button" class="btn btn-light-primary font-weight-bold btn-sm">NGN {{ number_format($user->balance) }}</button>
                                                        <p class="form-text text-muted pt-2">Total available balance. 
                                                        <a href="#" class="font-weight-bold">View transaction</a>.</p>
                                                    </div>
                                                </div>
                                                <!--begin::Form Group-->
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <button type="button" class="btn btn-light-primary font-weight-bold btn-sm">NGN {{ number_format($user->spent) }}</button>
                                                        <p class="form-text text-muted pt-2">All the funds spent. 
                                                        <a href="#" class="font-weight-bold">View transaction</a>.</p>
            ...
            <div class="offcanvas-wrapper mb-5 scroll-pull">
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo1/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo1/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                    ...
                    <div class="overlay-layer">
                        <a href="account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="../../../../rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo3/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo3/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo4/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo4/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo5/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo5/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo6/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo6/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo7/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo7/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo8/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo8/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo9/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo9/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo10/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo10/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo11/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo11/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo12/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo12/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
                ...
                <div class="overlay rounded-lg mb-8 offcanvas-demo">
                    ...
                    <div class="overlay-layer">
                        <a href="https://preview.keenthemes.com/metronic/demo13/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
                        <a href="https://preview.keenthemes.com/metronic/demo13/rtl/custom/apps/profile/profile-1/account-information.html" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow ml-3" target="_blank">RTL Version</a>
                    </div>
                </div>
