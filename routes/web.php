...
Route::get('/login', [App\Http\Controllers\FrontendController::class, 'index'])->name('home');
Route::get('/register', [App\Http\Controllers\FrontendController::class, 'index'])->name('home');

// Auth::routes();Route::get('/forgot-password', function () {
...
// Route::any('add_data_fee', function () {
//     $datas = Data::where('network', 1);
//     foreach ($datas as $data) {
//         $data->real_price = $data->actual_price + (0.1 * $data->actual_price);
//         $data->save();
//     }
