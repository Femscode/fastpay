...
Vue.component('payroll-component', require('./components/dashboard/PayrollComponent.vue').default);
Vue.component('setpin-component', require('./components/dashboard/SetpinComponent.vue').default);
Vue.component('failed-account', require('./components/dashboard/FailedAccount.vue').default);
Vue.component('transfer-component', require('./components/dashboard/TransferComponent.vue').default);
Vue.component('cttaste-component', require('./components/dashboard/CT_TasteComponent.vue').default);
